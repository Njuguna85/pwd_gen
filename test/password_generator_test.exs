defmodule PasswordGeneratorTest do
  ...
  test "returns error when 1 option is not allowed" do
    options = %{"length" => "5", "number" => "true", "invalid" => "true"}
  ...
  test "returns string with just numbers", %{options_type: options} do
  ...
  test "returns string with uppercase and numbers", %{options_type: options} do
    options_with_uppercase_numbers = %{
      "length" => "10",
      "numbers" => "true",
      "uppercase" => "true",
      "symbols" => "false"
    ...
    {:ok, result} = PasswordGenerator.generate(options_with_uppercase_numbers)
  ...
  test "returns string with symbols and uppercase", %{options_type: options} do
    options_with_symbols_uppercase = %{
      "length" => "10",
      "numbers" => "false",
      "uppercase" => "true",
      "symbols" => "true"
    ...
    {:ok, result} = PasswordGenerator.generate(options_with_symbols_uppercase)
  ...
  test "returns string with symbols and numbers", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(options_with_symbols_numbers)
